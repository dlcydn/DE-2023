...
public class IMDBStudent20180250 {
	...
	public static class IMDBMapper extends Mapper < Object, Text, DoubleString, Text > {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			if(movieFile) {
				String movie_id = splitVal[0];
				String movie_title = splitVal[1];
				String movie_genre = splitVal[2];
				...
				if(isFantasy) {
					...
					outValue.set("M," + movie_title);
					context.write( outputKey, outValue );
				}
			} else {
				String movie_id = splitVal[1];
				String movie_rate = splitVal[2];
				
				outputKey = new DoubleString(movie_id, "R");
				outValue.set("R," + movie_rate);
				context.write( outputKey, outValue );
			}
	...
	public static void main(String[] args) {
		...
		if (otherArgs.length != 3) {
			System.err.println("Usage: IMDBStudent20180250 <in> <out> <k>");
			System.exit(2);
		}
